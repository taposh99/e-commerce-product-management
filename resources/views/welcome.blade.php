    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <h1 class="text-2xl font-bold text-gray-900 mb-4">Welcome to Product Category Management</h1>
                <p class="text-gray-600 mb-6">This application allows you to manage products and categories with a many-to-many relationship.</p>
